...
void windowPlot::slot_actionExportQti(){
        auto temp_name = QString::number(sVar.temperature)+"K-"+ QString::number(sVar.magnetic_fild)+"T";
        QString filename = QFileDialog::getSaveFileName(this,"Export data to QtiPlot format",temp_name,"*.qti");
...
void windowPlot::slot_actionExportTxt(){
        auto temp_name = QString::number(sVar.temperature)+"K-"+ QString::number(sVar.magnetic_fild)+"T";
        QString filename = QFileDialog::getSaveFileName(this,"Export data to txt",temp_name,"*.txt");
